...
for window_size in ALEXNET_SIZE, VGG16_SIZE:
    ...
    vals = [
        ...
        RVvRHGVStimMaker(target_color=(255, 239, 213),
                         ...
                         item_bbox_size=ITEM_BBOX_SIZE,
                         jitter=JITTER),
        Two_v_Five_StimMaker(target_color='black',
                             ...
                             target_number=2,
                             distractor_number=5),
        TLStimMaker(background_color='white',
                    window_size=window_size,
                    border_size=BORDER_SIZE,
                    grid_size=GRID_SIZE,
                    item_bbox_size=ITEM_BBOX_SIZE,
                    jitter=JITTER),
        TLStimMaker(background_color='white', 
                    distractor_L_color=(100, 149, 237),
                    window_size=window_size,
                    border_size=BORDER_SIZE,
                    grid_size=GRID_SIZE,
                    item_bbox_size=ITEM_BBOX_SIZE,
...
def main():
    for cnn, zipped in zip(['alexnet', 'VGG16'], [alexnet_zip, vgg16_zip]):
        ...
        output_dir = OUTPUT_DIR.joinpath(f'{cnn}_multiple_stims_white_background')
