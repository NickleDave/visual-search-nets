...
In spite of the many attentional mechanisms proposed for neural networks, and the many parallels and links between studies of vision in psychology, neuroscience, and artificial intelligence, little work has been done to relate the tasks and models used to investigate visual attention to neural networks. Here we study the whether visual search tasks used to investigate attention and the different models of visual attention in the brain provide alternate ways of understanding existing CNNs, comparing their output with human behavior, and benchmarking new attentional mechansims.
