...
#### Psychometric curves
First we generated 'feature' search stimuli--red vertical rectangle v. green vertical rectangle.  
...
Here we see that the threshold goes up with set size, meaning more discriminable target-distractor pairs are required as set size increases.

For a detailed walkthrough of how we did this, please see [this notebook](./psychometrics.ipynb).
